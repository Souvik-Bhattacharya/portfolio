    ...
    return (
        <div>
            <div className='page'>
                ...
                <div className='grid grid-cols-card mini:grid-cols-card-mini gap-2 pl-32 pr-4 small:pl-14'>
                    <div className='flex flex-col justify-between hover:-translate-y-2 hover:shadow-lg hover:shadow-black rounded-3xl bg-sec p-3'>
                        ...
                        <div className='flex flex-col p-3'>
                            <div className='flex flex-col'>
                                <p className='text-lg small:text-base at'>Web Development Project Intern</p>
                                <p className='text-lg small:text-base'>July 2023 - September 2023</p>
                            </div>
                            <div className='flex justify-between py-2'>
                                <Link to='https://www.industryacademiacommunity.com/' target='blank' className='text-cyan text-lg small:text-base pr-1 at'>Cloud Counselage Pvt. Ltd.</Link>
                            ...
                            <p className='flex flex-col small:text-sm gap-2 py-2'>
                    ...
                    <div className='flex flex-col justify-between hover:-translate-y-2 hover:shadow-lg hover:shadow-black rounded-3xl bg-sec p-3'>
                        ...
                        <div className='flex flex-col p-3'>
                            <div className='flex flex-col'>
                                <p className='text-lg small:text-base at'>Frontend Developer</p>
                                <p className='text-lg small:text-base'>September 2023</p>
                            </div>
                            <div className='flex justify-between py-2'>
                                <Link to='https://www.sih.gov.in/' target='blank' className='text-cyan text-lg small:text-base pr-1 at'>SIH 2023</Link>
                                <div className='flex gap-3'>
                    ...
                    <div className='flex flex-col justify-between hover:-translate-y-2 hover:shadow-lg hover:shadow-black rounded-3xl bg-sec p-3'>
                        ...
                        <div className='flex flex-col p-3'>
                            <div className='flex flex-col'>
                                <p className='text-lg small:text-base at'>Contributor</p>
                                <p className='text-lg small:text-base'>October 2022</p>
                            </div>
                            <div className='flex justify-between py-2'>
                                <Link to='https://hacktoberfest.com/' target='blank' className='text-cyan text-lg small:text-base pr-1 at'>Hacktoberfest 2022</Link>
                                <div className='flex gap-3'>
            ...
            <div className='pr-4'>
                ...
                <div className='flex flex-col gap-3 pl-32 small:pl-14'>
                    <li className='text-cyan small:text-base'>
                    ...
                    <li className='text-cyan'>
                        <Link to='https://archive.nptel.ac.in/noc/Ecertificate/?q=NPTEL22CS31S2365048202202324' target='blank' className='small:text-base'>NPTEL certification - The Joy of Computing using Python</Link>
